...
<form method="post" action="deleteshop.php" id="fo">
<input type="submit" name="deleteaccount" value="حذف المتجر" onclick="if (!confirm('هل انت متأكد انك تريد حذف المتجر ؟ ')) return false;">
<!--it will be in php  -->
</form>
<br> <?php if (isset($del)): ?>  <span style="color:red;"><?php echo  $del; ?></span><br> <?php endif ?><br>
<br> <?php if (isset($err)): ?>  <span style="color:red;"><?php echo  $err; ?></span><br> <?php endif ?><br>
</main>
    <footer>
  <ul class="foot">
