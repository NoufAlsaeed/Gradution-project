...
<br>
  <h1 style="font-size: 200%" class="mt-7 pp  mainColor ">بائعيين جدد  </h1>
  <br>
...
$sql = "SELECT * FROM seller WHERE AccountState='غير مصرح'";
...
<th>اسم البائع</th>
  ...
  echo "<tr class='newnewwe'> ";  
      echo '<td> <div ><a name="acceptseller" href="adminprocess.php?iddd='.$row['id'].'"> <i style="font-size:24px" class="fa">&#xf00c;</i></a></div> </td>';
...
echo '<br> <br> <p style="font-size: 150%"> لا يوجد بائعيين جدد في الوقت الحالي </p> <br> <br> ';
