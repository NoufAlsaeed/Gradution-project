...
<main>
  ...
  <img src="images/leaf.png" style="width:30%;height:40%;"/> <br> 
  <h1 class="mt-7 pp mainColor mr-10" style="font-size: 3rem;"> خضراء </h1>

  <p style="text-align: center; color:mainColor; line-height: 1.8;text-align: justify;
  padding: 5%; text-align: right;">
لطالما كان تأثير النبات جيدًا على الانسان، ولطالما الاسلام حثنا على الزرع والغرس حيث قال سبحانه وتعالى: {فَأَْنَبتْنَا ِبِه َجنَّات َو َحب اْلحصيِد(9) َوالنَّخل َباسقَات لََها َطْلع نَضيد(10) ِرْزقًا ِلْلِعَباِد َوأَ ْحَيْينَا ِبِه َبْلَدةً َمْيتًا}[ق:9- 11]. عرف النبات انه يجلب الطاقة الإيجابية والسعادة لا سيما انه ايضا يقاوم التلوث البيئي وينتج الاكسجين، ومن اقوى اربعه مشاريع تحت رؤية السعودية ٢٠٣٠ نبع مشروع الرياض الخضراء الذي يعتبر داع ًما والذي يهدف الى
زرع وتخضير الرياض . ومن هنا جاءت فكرة خضراء، وهو موقع إلكتروني يوفر للمزارعين والمستخدمين البيئة المتكاملة للبيع والشراء، حيث يمكن المزارعين من عرض متاجرهم وما تحتويه من منتجات زراعية مثل أدوات للزراعة وحبوب ونباتات، حيث يمكن للمستخدم البحث عن محل ما أو البحث عن منتج ما يوافي متطلباته، يتميز الموقع بوجود نظام توصيات يساعد المستخدم على اختيار النبتة المناسبة. مما يجعل هذا الموقع مساهما في إعطاء دافع اقوى للشراء والزراعة، للمشاركة في جعل بيئتنا تخضر وزراعة بيوتنا والتي سوف تمكننا من اكل المنتجات العضوية الصحية وجلب الطاقة الإيجابية.
