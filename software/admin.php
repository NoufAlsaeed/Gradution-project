...
<br> 
  ...
  <h1 class="mt-7 pp mainColor" style="font-size: 200%">إدارة المتاجر </h1>


 <div class="homeflex-container">

 <div class="homeflex-item-left"> <a href="allsellers.php"> <img src="images/login.svg"><br> كل البائعين</a>   </div>  

  
  
  <div class="homeflex-item-right">  <a href="newsellers.php"> <img src="images/sign-up.svg"> <br> بائعين جدد  </a></div>
   <div class="homeflex-item-right">  <a href="requesttodeleteaccount.php"> <img src="images/delete-account.svg"> <br> طلبات حذف الحساب  </a></div>
</div> 

<!--
 
<div class = "admincontrolpage">
<h3>ادارة المتاجر</h3>
<table class="admincontrolcontent">
<tr>
<th>طلب حذف الحساب</th>
<th>قبول المتجر</th>
<th> السجل التجاري</th>
<th>أسم المتجر</th>
<th>أسم المتجر</th>
<th>حذف حساب المتجر</th>
</tr>
<tr>
<td><div class="buttonAdmin"><a a href="#deleteShop.php" onclick="if (!confirm('Are you sure?')) return false;"> قبول</a></div><div class="buttonAdmin"><a href="#deleteShop"> رفض</a></div></td>
<td><div class="buttonAdmin"><a href="#a"> قبول</div><div class="buttonAdmin"><a href="#deleteShop"> رفض</div></td>
<td>3246456890</td>
<td>شتلات</td>
<td>محمد</td>
<td><div class="buttonAdmin"><a href="#deleteShop.php" onclick="if (!confirm('Are you sure?')) return false;"> حذف المتجر</a></div></td>
</tr>
<tr>
<td><div class="buttonAdmin"><a href="#deleteShop.php" onclick="if (!confirm('Are you sure?')) return false;"> قبول</a></div><div class="buttonAdmin"><a href="#deleteShop"> رفض</a></div></td>
<td><div class="buttonAdmin"><a href="#deleteShop"> قبول</a></div><div class="buttonAdmin"><a href="#deleteShop"> رفض</a></div></td>
<td>3246456890</td>
<td>شتلات</td>
<td>محمد</td>
<td><div class="buttonAdmin"><a href="#deleteShop.php" onclick="if (!confirm('Are you sure?')) return false;"> حذف المتجر</a></div></td>
