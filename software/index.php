...
<select   style="
  ...
  border: none;
  border-radius: 14px;
  background-color: #f1f1f1;"  onchange='myFunction(this.value)' > 

<option value="white"> <?php// echo " لون الصفحة"; ?></option>
<option value="#dee1e6">رمادي</option>
<option value="white">أبيض</option>
<option value="  #e6ffcc">أخضر</option>

</select>
--> 
<script>
function myFunction(val) {
    document.body.bgColor= val;
}
...
<div class="homeflex-container">
 <div class="homeflex-item-left"> <a href="shopslist.php"> <img src="images/flower-shop-2.png"><br> تسوق من البائعين</a>   </div>  

  
  
  <div class="homeflex-item-right">  <a href="shopproduct.php"> <img src="images/plants.svg"> <br> تسوق منتجات </a></div>
