...
<h1 class="mb-5 pr-3 mt-3 text-center mainColor pp" style="font-size: 170%"> عرض المنتجات </h1>
<br>
...
$sqle = "SELECT * FROM product WHERE productType = '$productType' AND requestedToDeleteProduct='N' ";  
...
echo "<div class='conOfPrcolumn'><a href='productpage.php?idd=".$row['productID']."'><img src='data:image/png;base64,".( $row["productPic"] )."' /></a> </div>";
	...
	<input type='hidden' name='ShopName' value=".$roww["ShopName"]." />
	<div class='name'>".$roww["ShopName"]."</div>
    <div class='name'>".$row["productName"]."</div>
	<p><div class='price'>  السعر: ".$row["productPrice"]." ر.س</div> </p>  <br>
