...
<br>
  <h1 style="font-size: 200%" class="mt-7 pp  mainColor "> قائمة المتاجر </h1>
  <br>
...
echo '
<table class="admincontrolcontent mainbag" style="line-height:150%;" >';
echo '<thead>';
echo "<tr>
<th> الغاء تصريح المتجر </th>
...
echo '<td> <div  class=""><a style="text-decoration:none" name="aunauthorize" href="adminprocess3.php?idddddd='.$row['id'].'"> &#10060; </a></div> </td>';
      echo '<td> <div class=""><a name="deleteseller" href="adminprocess2.php?iddddd='.$row['id'].'"><i style="color:red"class="fa fa-trash-o"></i></a></div> </td>';
...
echo '<br> <br> <p style="font-size: 150%; color:lightgrey"> لا توجد بائعيين جدد في الوقت الحالي </p> <br> <br> ';
