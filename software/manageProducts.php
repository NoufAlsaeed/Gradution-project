...
<img src="images/flower.jpg" alt="khadra" /> 
<br>
<iframe name="quantity" style="display:none;"></iframe>
<label for="number" class = "text">: العدد المتوفر في المخزن</label>
...
<br>
<div class="buttonProfile"><a href="#deleteshop.php">حذف المنتج </a></div>
</div>
