...
<br><h1 class='mb-3 pr-0 mt-3 text-center mainColor pp' style='font-size: 170%'>متسوق جديد </h1>
  <br> 
<div class="container nprofileBorder-1" class="mainbag" >
 <!-- ------------------------------------------------------------------------------------------>  

<form method="post" action="signup.php"onsubmit="valform2();" id="form2" enctype="multipart/form-data" class="mainbag p-5" dir="rtl">



<label class="d-block text-right mb-2">اسم المستخدم: </label>
<input type="text" id="username" name="username" value="<?php if(!empty($username)){echo $username;} ?>" placeholder="اسم المستخدم"  maxlength="45" class="form-control" required>  
...
<input type="tel" id="phone" name="phonenumber" value="<?php if(!empty($phonenumber)){echo $phonenumber;} ?>" placeholder="رقم الهاتف" class="form-control" maxlength="13" required>  
...
<input type="email" id="email" name="email" value="<?php if(!empty($email)){echo $email;} ?>"  placeholder="البريد الالكتروني" maxlength="255"  class="form-control" required> 
...
<input type="password" id="password" name="password"  placeholder="كلمة المرور"  class="form-control" maxlength="255" required>
...
<br />
  <div> <input  class="btn-success" type="submit" value="تسجيل الدخول" name="register"></div>
