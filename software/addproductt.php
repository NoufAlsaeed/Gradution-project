...
<h1 class="mb-5 pr-3 mt-3 text-center mainColor pp" style="font-size: 170%">  اختر نوع النبته التي تريد اضافتها    </h1>
<br> 
<div class = "containerSVP">
<div class="column"><img src="images/tree.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="addtype.php?type=الأشجار">الأشجار</a></div>
</div>
<div class="provvv mb-5"><img src="images/Shrubbery.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a  href="addtype.php?type=الشجيرات">الشجيرات</a></div>
</div>
<div class="provvv mb-5"><img src="images/climping.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="addtype.php?type=النباتات المتسلقة">النباتات المتسلقة</a></div>
</div>
<div class="provvv mb-5"><img src="images/Herbaceous.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="addtype.php?type=النباتات العشبية">النباتات العشبية</a> </div>
</div> 
<div class="provvv mb-5"><img src="images/palm.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="addtype.php?type=النخيل ، السيكاد">النخيل</a></div>
</div>
<div class="provvv mb-5"><img src="images/cactus.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="addtype.php?type=الصبار ، العصاريات">الصبار  , العصاريات </a></div>
</div>

<div class="provvv mb-5"><img src="images/seaweed.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="addtype.php?type=النباتات المائية">النباتات المائية</a>  </div>
</div>
