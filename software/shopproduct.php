...
<h1 class="mb-5 pr-3 mt-3 text-center mainColor pp" style="font-size: 170%"> تسوق حسب المنتجات    </h1>

<div class = "containerSVP">
<div class="column"><img src="images/tree.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="shopproducttype.php?type=الأشجار">الأشجار</a></div>
</div>
<div class="provvv mb-5"><img src="images/Shrubbery.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a  href="shopproducttype.php?type=الشجيرات">الشجيرات</a></div>
</div>
<div class="provvv mb-5"><img src="images/climping.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="shopproducttype.php?type=النباتات المتسلقة">النباتات المتسلقة</a></div>
</div>
<div class="provvv mb-5"><img src="images/Herbaceous.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="shopproducttype.php?type=النباتات العشبية">النباتات العشبية</a> </div>
</div> 
<div class="provvv mb-5"><img src="images/palm.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="shopproducttype.php?type=النخيل ، السيكاد">النخيل</a></div>
</div>
<div class="provvv mb-5"><img src="images/cactus.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="shopproducttype.php?type=الصبار ، العصاريات">الصبار  , العصاريات </a></div>
</div>

<div class="provvv mb-5"><img src="images/seaweed.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="shopproducttype.php?type=النباتات المائية">النباتات المائية</a>  </div>
</div>

<div class="provvv mb-5"><img src="images/shovel.png" alt="khadra" /> 

 <div class="buttonProfile btn btn-success mt-2"><a href="shopproducttype.php?type=ادوات زراعية">ادوات زراعية </a> </div>
</div>
...
<br>
    ...
    <footer>
  <ul class="foot" style="">
   <li style="display:inline-block;"> <a href="joinus.php"> <img src="images/collaboration.png" alt="khadra" /> انضم الينا  </a></li> 
    <li style="display:inline-block;"> <a href="mailto:noufib1252@gmail.com">  <img src="images/call-center.png" alt="khadra" /> تواصل معنا  </a> </li> 
    </ul>
</footer>
  </body>
