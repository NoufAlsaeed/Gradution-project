...
<main>
  ...
  <form action="buyerorders.php"> 

<div class = "nprofilePage-1" class="mainbag-d">
<h3 class="pt-3 pp mainColor"> الملف الشخصي </h3>
<br> 
<div class = "container" class="mainbag" > 
...
$query = "SELECT  Full_name , email , phone_number FROM buyer WHERE id = '$ie'";
...
if ($stmt = $con->prepare($query)) {
    ...
    echo "<h2 id='in' class='mainColor' style='text-align: center;' >  مرحبا $Full_name \n  </h2>". " ";
    

  echo '<div dir="rtl" class="mainbag p-2 mt-2" >';

    echo '<label class="d-block text-right mb-2">الإســـــــم:</label>';
    echo '<label style="background-color:white; text-align:right;" type="text" value=""  readonly class="form-control">'.$Full_name.'</label>';

    echo "<br>";

    echo '<label class="d-block text-right mb-2">البريد الالكتروني:</label>';
    echo '<label  style="background-color:white; text-align:right;" type="text" value=""  readonly class="form-control">'.$email.'</label>';

    echo "<br>";

    echo '<label class="d-block text-right mb-2">رقم الهاتف:</label>';
    echo '<label style="background-color:white; text-align:right;" type="text" value=""  readonly class="form-control"> '.$phone_number.'</label>';
...
<div class="btn-success"><a href="editbuyerprofile.php" class="button1 bouncy" style="animation-delay:0.07s"> تعديل معلومات الملف الشخصي</div> <br><br> 
<div  class="btn-success"><a href="buyerorders.php" style="animation-delay:0.07s"
> قائمة طلباتي </a></div>
</form>
